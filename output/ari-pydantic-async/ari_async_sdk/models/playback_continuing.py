...
class PlaybackContinuing(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlaybackContinuing:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlaybackContinuing:
        """Create an instance of PlaybackContinuing from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlaybackContinuing.parse_obj(obj)

        _obj = PlaybackContinuing.parse_obj({
