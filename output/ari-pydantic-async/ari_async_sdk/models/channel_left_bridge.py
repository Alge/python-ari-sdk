...
class ChannelLeftBridge(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelLeftBridge:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelLeftBridge:
        """Create an instance of ChannelLeftBridge from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelLeftBridge.parse_obj(obj)

        _obj = ChannelLeftBridge.parse_obj({
