...
class ChannelCreated(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelCreated:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelCreated:
        """Create an instance of ChannelCreated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelCreated.parse_obj(obj)

        _obj = ChannelCreated.parse_obj({
