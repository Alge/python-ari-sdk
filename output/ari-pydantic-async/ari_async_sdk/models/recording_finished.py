...
class RecordingFinished(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordingFinished:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordingFinished:
        """Create an instance of RecordingFinished from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordingFinished.parse_obj(obj)

        _obj = RecordingFinished.parse_obj({
