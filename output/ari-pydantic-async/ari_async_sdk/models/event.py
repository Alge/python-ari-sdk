...
class Event(Message):
    ...
    Event
    """
    application: StrictStr = Field(default=..., description="Name of the application receiving the event.")
    timestamp: date = Field(default=..., description="Time at which this event was created.")
    __properties = ["asterisk_id", "type", "application", "timestamp"]
    ...
    def from_dict(cls, obj: dict) -> Union(ApplicationMoveFailed, ApplicationReplaced, BridgeAttendedTransfer, BridgeBlindTransfer, BridgeCreated, BridgeDestroyed, BridgeMerged, BridgeVideoSourceChanged, ChannelCallerId, ChannelConnectedLine, ChannelCreated, ChannelDestroyed, ChannelDialplan, ChannelDtmfReceived, ChannelEnteredBridge, ChannelHangupRequest, ChannelHold, ChannelLeftBridge, ChannelStateChange, ChannelTalkingFinished, ChannelTalkingStarted, ChannelUnhold, ChannelUserevent, ChannelVarset, ContactStatusChange, DeviceStateChanged, Dial, EndpointStateChange, PeerStatusChange, PlaybackContinuing, PlaybackFinished, PlaybackStarted, RecordingFailed, RecordingFinished, RecordingStarted, StasisEnd, StasisStart, TextMessageReceived):
        ...
        if object_type ==  'ApplicationMoveFailed':
            return import_module("ari_async_sdk.models.application_move_failed").ApplicationMoveFailed.from_dict(obj)
        if object_type ==  'ApplicationReplaced':
            return import_module("ari_async_sdk.models.application_replaced").ApplicationReplaced.from_dict(obj)
        if object_type ==  'BridgeAttendedTransfer':
            return import_module("ari_async_sdk.models.bridge_attended_transfer").BridgeAttendedTransfer.from_dict(obj)
        if object_type ==  'BridgeBlindTransfer':
            return import_module("ari_async_sdk.models.bridge_blind_transfer").BridgeBlindTransfer.from_dict(obj)
        if object_type ==  'BridgeCreated':
            return import_module("ari_async_sdk.models.bridge_created").BridgeCreated.from_dict(obj)
        if object_type ==  'BridgeDestroyed':
            return import_module("ari_async_sdk.models.bridge_destroyed").BridgeDestroyed.from_dict(obj)
        if object_type ==  'BridgeMerged':
            return import_module("ari_async_sdk.models.bridge_merged").BridgeMerged.from_dict(obj)
        if object_type ==  'BridgeVideoSourceChanged':
            return import_module("ari_async_sdk.models.bridge_video_source_changed").BridgeVideoSourceChanged.from_dict(obj)
        if object_type ==  'ChannelCallerId':
            return import_module("ari_async_sdk.models.channel_caller_id").ChannelCallerId.from_dict(obj)
        if object_type ==  'ChannelConnectedLine':
            return import_module("ari_async_sdk.models.channel_connected_line").ChannelConnectedLine.from_dict(obj)
        if object_type ==  'ChannelCreated':
            return import_module("ari_async_sdk.models.channel_created").ChannelCreated.from_dict(obj)
        if object_type ==  'ChannelDestroyed':
            return import_module("ari_async_sdk.models.channel_destroyed").ChannelDestroyed.from_dict(obj)
        if object_type ==  'ChannelDialplan':
            return import_module("ari_async_sdk.models.channel_dialplan").ChannelDialplan.from_dict(obj)
        if object_type ==  'ChannelDtmfReceived':
            return import_module("ari_async_sdk.models.channel_dtmf_received").ChannelDtmfReceived.from_dict(obj)
        if object_type ==  'ChannelEnteredBridge':
            return import_module("ari_async_sdk.models.channel_entered_bridge").ChannelEnteredBridge.from_dict(obj)
        if object_type ==  'ChannelHangupRequest':
            return import_module("ari_async_sdk.models.channel_hangup_request").ChannelHangupRequest.from_dict(obj)
        if object_type ==  'ChannelHold':
            return import_module("ari_async_sdk.models.channel_hold").ChannelHold.from_dict(obj)
        if object_type ==  'ChannelLeftBridge':
            return import_module("ari_async_sdk.models.channel_left_bridge").ChannelLeftBridge.from_dict(obj)
        if object_type ==  'ChannelStateChange':
            return import_module("ari_async_sdk.models.channel_state_change").ChannelStateChange.from_dict(obj)
        if object_type ==  'ChannelTalkingFinished':
            return import_module("ari_async_sdk.models.channel_talking_finished").ChannelTalkingFinished.from_dict(obj)
        if object_type ==  'ChannelTalkingStarted':
            return import_module("ari_async_sdk.models.channel_talking_started").ChannelTalkingStarted.from_dict(obj)
        if object_type ==  'ChannelUnhold':
            return import_module("ari_async_sdk.models.channel_unhold").ChannelUnhold.from_dict(obj)
        if object_type ==  'ChannelUserevent':
            return import_module("ari_async_sdk.models.channel_userevent").ChannelUserevent.from_dict(obj)
        if object_type ==  'ChannelVarset':
            return import_module("ari_async_sdk.models.channel_varset").ChannelVarset.from_dict(obj)
        if object_type ==  'ContactStatusChange':
            return import_module("ari_async_sdk.models.contact_status_change").ContactStatusChange.from_dict(obj)
        if object_type ==  'DeviceStateChanged':
            return import_module("ari_async_sdk.models.device_state_changed").DeviceStateChanged.from_dict(obj)
        if object_type ==  'Dial':
            return import_module("ari_async_sdk.models.dial").Dial.from_dict(obj)
        if object_type ==  'EndpointStateChange':
            return import_module("ari_async_sdk.models.endpoint_state_change").EndpointStateChange.from_dict(obj)
        if object_type ==  'PeerStatusChange':
            return import_module("ari_async_sdk.models.peer_status_change").PeerStatusChange.from_dict(obj)
        if object_type ==  'PlaybackContinuing':
            return import_module("ari_async_sdk.models.playback_continuing").PlaybackContinuing.from_dict(obj)
        if object_type ==  'PlaybackFinished':
            return import_module("ari_async_sdk.models.playback_finished").PlaybackFinished.from_dict(obj)
        if object_type ==  'PlaybackStarted':
            return import_module("ari_async_sdk.models.playback_started").PlaybackStarted.from_dict(obj)
        if object_type ==  'RecordingFailed':
            return import_module("ari_async_sdk.models.recording_failed").RecordingFailed.from_dict(obj)
        if object_type ==  'RecordingFinished':
            return import_module("ari_async_sdk.models.recording_finished").RecordingFinished.from_dict(obj)
        if object_type ==  'RecordingStarted':
            return import_module("ari_async_sdk.models.recording_started").RecordingStarted.from_dict(obj)
        if object_type ==  'StasisEnd':
            return import_module("ari_async_sdk.models.stasis_end").StasisEnd.from_dict(obj)
        if object_type ==  'StasisStart':
            return import_module("ari_async_sdk.models.stasis_start").StasisStart.from_dict(obj)
        if object_type ==  'TextMessageReceived':
            return import_module("ari_async_sdk.models.text_message_received").TextMessageReceived.from_dict(obj)
