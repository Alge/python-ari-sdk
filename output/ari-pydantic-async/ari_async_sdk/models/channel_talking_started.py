...
class ChannelTalkingStarted(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelTalkingStarted:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelTalkingStarted:
        """Create an instance of ChannelTalkingStarted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelTalkingStarted.parse_obj(obj)

        _obj = ChannelTalkingStarted.parse_obj({
