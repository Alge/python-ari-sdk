...
class ChannelStateChange(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelStateChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelStateChange:
        """Create an instance of ChannelStateChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelStateChange.parse_obj(obj)

        _obj = ChannelStateChange.parse_obj({
