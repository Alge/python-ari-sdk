...
class ChannelDtmfReceived(Event):
    ...
    digit: StrictStr = Field(default=..., description="DTMF digit received (0-9, A-E, # or *)")
    duration_ms: StrictInt = Field(default=..., description="Number of milliseconds DTMF was received")
    __properties = ["application", "timestamp", "asterisk_id", "type", "channel", "digit", "duration_ms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelDtmfReceived:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelDtmfReceived:
        """Create an instance of ChannelDtmfReceived from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelDtmfReceived.parse_obj(obj)

        _obj = ChannelDtmfReceived.parse_obj({
