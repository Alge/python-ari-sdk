...
class ChannelConnectedLine(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelConnectedLine:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelConnectedLine:
        """Create an instance of ChannelConnectedLine from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelConnectedLine.parse_obj(obj)

        _obj = ChannelConnectedLine.parse_obj({
