...
class StasisStart(Event):
    ...
    __properties = ["application", "timestamp", "asterisk_id", "type", "args", "channel", "replace_channel"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StasisStart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StasisStart:
        """Create an instance of StasisStart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StasisStart.parse_obj(obj)

        _obj = StasisStart.parse_obj({
