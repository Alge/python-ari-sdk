...
import ari_async_sdk.models
from ari_async_sdk import rest
from ari_async_sdk.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ari_async_sdk.models, klass)
