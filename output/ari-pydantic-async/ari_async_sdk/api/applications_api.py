...
class ApplicationsApi:
    ...
    @validate_arguments
    async def filter(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], filter : Annotated[Optional[Dict[str, Any]], Field(description="Specify which event types to allow/disallow")] = None, **kwargs) -> Application:  # noqa: E501
        ...
        return await self.filter_with_http_info(application_name, filter, **kwargs)  # noqa: E501

    @validate_arguments
    async def filter_with_http_info(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], filter : Annotated[Optional[Dict[str, Any]], Field(description="Specify which event types to allow/disallow")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Filter application events types.  # noqa: E501
    ...
    @validate_arguments
    async def get(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], **kwargs) -> Application:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.get_with_http_info(application_name, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_with_http_info(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get details of an application.  # noqa: E501
    ...
    @validate_arguments
    async def list(self, **kwargs) -> List[Application]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.list_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def list_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List all applications.  # noqa: E501
    ...
    @validate_arguments
    async def subscribe(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], event_source : Annotated[conlist(StrictStr), Field(..., description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}")], **kwargs) -> Application:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.subscribe_with_http_info(application_name, event_source, **kwargs)  # noqa: E501

    @validate_arguments
    async def subscribe_with_http_info(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], event_source : Annotated[conlist(StrictStr), Field(..., description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}")], **kwargs) -> ApiResponse:  # noqa: E501
        """Subscribe an application to a event source.  # noqa: E501
    ...
    @validate_arguments
    async def unsubscribe(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], event_source : Annotated[conlist(StrictStr), Field(..., description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}")], **kwargs) -> Application:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.unsubscribe_with_http_info(application_name, event_source, **kwargs)  # noqa: E501

    @validate_arguments
    async def unsubscribe_with_http_info(self, application_name : Annotated[StrictStr, Field(..., description="Application's name")], event_source : Annotated[conlist(StrictStr), Field(..., description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}")], **kwargs) -> ApiResponse:  # noqa: E501
        """Unsubscribe an application from an event source.  # noqa: E501
