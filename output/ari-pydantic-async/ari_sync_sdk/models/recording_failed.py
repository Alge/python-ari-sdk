...
class RecordingFailed(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordingFailed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordingFailed:
        """Create an instance of RecordingFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordingFailed.parse_obj(obj)

        _obj = RecordingFailed.parse_obj({
