...
class EndpointStateChange(Event):
    ...
    __properties = ["application", "timestamp", "asterisk_id", "type", "endpoint"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointStateChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointStateChange:
        """Create an instance of EndpointStateChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointStateChange.parse_obj(obj)

        _obj = EndpointStateChange.parse_obj({
