...
class PeerStatusChange(Event):
    ...
    peer: Peer = Field(...)
    __properties = ["application", "timestamp", "asterisk_id", "type", "endpoint", "peer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PeerStatusChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PeerStatusChange:
        """Create an instance of PeerStatusChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PeerStatusChange.parse_obj(obj)

        _obj = PeerStatusChange.parse_obj({
