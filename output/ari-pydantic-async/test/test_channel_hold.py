...
from ari_async_sdk.models.channel_hold import ChannelHold  # noqa: E501
...
class TestChannelHold(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChannelHold:
        """Test ChannelHold
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelHold`
        """
        model = ChannelHold()  # noqa: E501
        if include_optional:
            return ChannelHold(
