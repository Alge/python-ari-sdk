...
from ari_async_sdk.models.channel_varset import ChannelVarset  # noqa: E501
...
class TestChannelVarset(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChannelVarset:
        """Test ChannelVarset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelVarset`
        """
        model = ChannelVarset()  # noqa: E501
        if include_optional:
