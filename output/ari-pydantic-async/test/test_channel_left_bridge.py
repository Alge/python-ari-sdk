...
from ari_async_sdk.models.channel_left_bridge import ChannelLeftBridge  # noqa: E501
...
class TestChannelLeftBridge(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChannelLeftBridge:
        """Test ChannelLeftBridge
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelLeftBridge`
        """
        model = ChannelLeftBridge()  # noqa: E501
        if include_optional:
