...
from ari_async_sdk.api.channels_api import ChannelsApi  # noqa: E501


class TestChannelsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_moh(self) -> None:
    ...
    async def test_continue_in_dialplan(self) -> None:
    ...
    async def test_createchannel(self) -> None:
    ...
    async def test_deletemoh(self) -> None:
    ...
    async def test_external_media(self) -> None:
    ...
    async def test_get_channel_var(self) -> None:
    ...
    async def test_getchannel(self) -> None:
    ...
    async def test_listchannels(self) -> None:
    ...
    async def test_originate(self) -> None:
    ...
    async def test_originate_with_id(self) -> None:
    ...
    async def test_play_sound_with_id(self) -> None:
    ...
    async def test_playsound(self) -> None:
    ...
    async def test_recordchannel(self) -> None:
    ...
    async def test_ring_stop(self) -> None:
    ...
    async def test_rtpstatistics(self) -> None:
    ...
    async def test_set_channel_var(self) -> None:
    ...
    async def test_snoop_channel(self) -> None:
    ...
    async def test_snoop_channel_with_id(self) -> None:
    ...
    async def test_start_silence(self) -> None:
    ...
    async def test_stop_silence(self) -> None:
    ...
    async def test_unhold(self) -> None:
