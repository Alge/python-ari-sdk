...
class TestChannelTalkingFinished(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChannelTalkingFinished:
        """Test ChannelTalkingFinished
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelTalkingFinished`
        """
        model = ChannelTalkingFinished()
        if include_optional:
