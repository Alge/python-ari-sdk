...
class TestBridgeVideoSourceChanged(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BridgeVideoSourceChanged:
        """Test BridgeVideoSourceChanged
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BridgeVideoSourceChanged`
        """
        model = BridgeVideoSourceChanged()
        if include_optional:
