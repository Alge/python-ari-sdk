...
class RecordingFailed(Event):
    ...
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "recording"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "recording": LiveRecording.from_dict(obj["recording"]) if obj.get("recording") is not None else None
        })
        return _obj
