...
class Event(Message):
    ...
    Event
    """ # noqa: E501
    application: StrictStr = Field(description="Name of the application receiving the event.")
    timestamp: date = Field(description="Time at which this event was created.")
    __properties: ClassVar[List[str]] = ["asterisk_id", "type", "application", "timestamp"]
