...
class PlaybackContinuing(Event):
    ...
    """ # noqa: E501
    playback: Playback
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "playback"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "playback": Playback.from_dict(obj["playback"]) if obj.get("playback") is not None else None
        })
        return _obj
