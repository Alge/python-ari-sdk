...
class BridgeAttendedTransfer(Event):
    ...
    destination_type: StrictStr = Field(description="How the transfer was accomplished")
    is_external: StrictBool = Field(description="Whether the transfer was externally initiated or not")
    replace_channel: Optional[Channel] = None
    result: StrictStr = Field(description="The result of the transfer attempt")
    ...
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "destination_application", "destination_bridge", "destination_link_first_leg", "destination_link_second_leg", "destination_threeway_bridge", "destination_threeway_channel", "destination_type", "is_external", "replace_channel", "result", "transfer_target", "transferee", "transferer_first_leg", "transferer_first_leg_bridge", "transferer_second_leg", "transferer_second_leg_bridge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destination_link_first_leg": Channel.from_dict(obj["destination_link_first_leg"]) if obj.get("destination_link_first_leg") is not None else None,
            "destination_link_second_leg": Channel.from_dict(obj["destination_link_second_leg"]) if obj.get("destination_link_second_leg") is not None else None,
            "destination_threeway_bridge": Bridge.from_dict(obj["destination_threeway_bridge"]) if obj.get("destination_threeway_bridge") is not None else None,
            "destination_threeway_channel": Channel.from_dict(obj["destination_threeway_channel"]) if obj.get("destination_threeway_channel") is not None else None,
            "destination_type": obj.get("destination_type"),
            "is_external": obj.get("is_external"),
            "replace_channel": Channel.from_dict(obj["replace_channel"]) if obj.get("replace_channel") is not None else None,
            "result": obj.get("result"),
            "transfer_target": Channel.from_dict(obj["transfer_target"]) if obj.get("transfer_target") is not None else None,
            "transferee": Channel.from_dict(obj["transferee"]) if obj.get("transferee") is not None else None,
            "transferer_first_leg": Channel.from_dict(obj["transferer_first_leg"]) if obj.get("transferer_first_leg") is not None else None,
            "transferer_first_leg_bridge": Bridge.from_dict(obj["transferer_first_leg_bridge"]) if obj.get("transferer_first_leg_bridge") is not None else None,
            "transferer_second_leg": Channel.from_dict(obj["transferer_second_leg"]) if obj.get("transferer_second_leg") is not None else None,
            "transferer_second_leg_bridge": Bridge.from_dict(obj["transferer_second_leg_bridge"]) if obj.get("transferer_second_leg_bridge") is not None else None
        })
        return _obj
