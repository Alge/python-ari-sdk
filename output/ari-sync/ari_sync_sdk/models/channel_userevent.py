...
class ChannelUserevent(Event):
    ...
    eventname: StrictStr = Field(description="The name of the user event.")
    userevent: Dict[str, Any] = Field(description="Custom Userevent data")
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "bridge", "channel", "endpoint", "eventname", "userevent"]
