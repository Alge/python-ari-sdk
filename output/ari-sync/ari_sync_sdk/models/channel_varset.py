...
class ChannelVarset(Event):
    ...
    value: StrictStr = Field(description="The new value of the variable.")
    variable: StrictStr = Field(description="The variable that changed.")
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "channel", "value", "variable"]
