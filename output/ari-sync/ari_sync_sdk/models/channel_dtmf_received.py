...
class ChannelDtmfReceived(Event):
    ...
    """ # noqa: E501
    channel: Channel
    digit: StrictStr = Field(description="DTMF digit received (0-9, A-E, # or *)")
    duration_ms: StrictInt = Field(description="Number of milliseconds DTMF was received")
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "channel", "digit", "duration_ms"]
