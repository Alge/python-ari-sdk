...
class AsteriskInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["build", "config", "status", "system"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": ConfigInfo.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "status": StatusInfo.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "system": SystemInfo.from_dict(obj["system"]) if obj.get("system") is not None else None
        })
        return _obj
