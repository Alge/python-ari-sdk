...
class ChannelDestroyed(Event):
    ...
    ChannelDestroyed
    """ # noqa: E501
    cause: StrictInt = Field(description="Integer representation of the cause of the hangup")
    cause_txt: StrictStr = Field(description="Text representation of the cause of the hangup")
    channel: Channel
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "cause", "cause_txt", "channel"]
