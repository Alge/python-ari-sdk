...
class Endpoint(BaseModel):
    ...
    """ # noqa: E501
    channel_ids: List[StrictStr] = Field(description="Id's of channels associated with this endpoint")
    resource: StrictStr = Field(description="Identifier of the endpoint, specific to the given technology.")
    state: Optional[StrictStr] = Field(default=None, description="Endpoint's state")
    technology: StrictStr = Field(description="Technology of the endpoint")
    __properties: ClassVar[List[str]] = ["channel_ids", "resource", "state", "technology"]
