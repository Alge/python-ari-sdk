...
class ChannelTalkingFinished(Event):
    ...
    """ # noqa: E501
    channel: Channel
    duration: StrictInt = Field(description="The length of time, in milliseconds, that talking was detected on the channel")
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "channel", "duration"]
