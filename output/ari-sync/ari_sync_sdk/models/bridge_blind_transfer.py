...
class BridgeBlindTransfer(Event):
    ...
    channel: Channel
    context: StrictStr = Field(description="The context transferred to")
    exten: StrictStr = Field(description="The extension transferred to")
    ...
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "bridge", "channel", "context", "exten", "is_external", "replace_channel", "result", "transferee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "bridge": Bridge.from_dict(obj["bridge"]) if obj.get("bridge") is not None else None,
