...
class TextMessageReceived(Event):
    ...
    message: TextMessage
    __properties: ClassVar[List[str]] = ["application", "timestamp", "asterisk_id", "type", "endpoint", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": TextMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
