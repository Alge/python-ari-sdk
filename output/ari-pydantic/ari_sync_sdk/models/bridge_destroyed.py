...
class BridgeDestroyed(Event):
    ...
    """
    bridge: Bridge = Field(...)
    __properties = ["application", "timestamp", "asterisk_id", "type", "bridge"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BridgeDestroyed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BridgeDestroyed:
        """Create an instance of BridgeDestroyed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BridgeDestroyed.parse_obj(obj)

        _obj = BridgeDestroyed.parse_obj({
