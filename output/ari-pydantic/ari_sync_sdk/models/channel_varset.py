...
class ChannelVarset(Event):
    ...
    value: StrictStr = Field(default=..., description="The new value of the variable.")
    variable: StrictStr = Field(default=..., description="The variable that changed.")
    __properties = ["application", "timestamp", "asterisk_id", "type", "channel", "value", "variable"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelVarset:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelVarset:
        """Create an instance of ChannelVarset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelVarset.parse_obj(obj)

        _obj = ChannelVarset.parse_obj({
