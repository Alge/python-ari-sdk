...
class ChannelTalkingFinished(Event):
    ...
    duration: StrictInt = Field(default=..., description="The length of time, in milliseconds, that talking was detected on the channel")
    __properties = ["application", "timestamp", "asterisk_id", "type", "channel", "duration"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelTalkingFinished:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelTalkingFinished:
        """Create an instance of ChannelTalkingFinished from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelTalkingFinished.parse_obj(obj)

        _obj = ChannelTalkingFinished.parse_obj({
