...
class PlaybackFinished(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlaybackFinished:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlaybackFinished:
        """Create an instance of PlaybackFinished from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlaybackFinished.parse_obj(obj)

        _obj = PlaybackFinished.parse_obj({
