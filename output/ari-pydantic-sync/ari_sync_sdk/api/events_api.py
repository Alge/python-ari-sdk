...
class EventsApi:
    ...
    @validate_arguments
    def event_websocket(self, app : Annotated[conlist(StrictStr), Field(..., description="Applications to subscribe to.")], subscribe_all : Annotated[Optional[StrictBool], Field(description="Subscribe to all Asterisk events. If provided, the applications listed will be subscribed to all events, effectively disabling the application specific subscriptions. Default is 'false'.")] = None, **kwargs) -> Message:  # noqa: E501
        """WebSocket connection for events.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.event_websocket(app, subscribe_all, async_req=True)
        >>> result = thread.get()
        ...
        return self.event_websocket_with_http_info(app, subscribe_all, **kwargs)  # noqa: E501
    ...
    def event_websocket_with_http_info(self, app : Annotated[conlist(StrictStr), Field(..., description="Applications to subscribe to.")], subscribe_all : Annotated[Optional[StrictBool], Field(description="Subscribe to all Asterisk events. If provided, the applications listed will be subscribed to all events, effectively disabling the application specific subscriptions. Default is 'false'.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.event_websocket_with_http_info(app, subscribe_all, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def user_event(self, event_name : Annotated[StrictStr, Field(..., description="Event name")], application : Annotated[StrictStr, Field(..., description="The name of the application that will receive this event")], source : Annotated[Optional[conlist(StrictStr)], Field(description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}/{resource}, deviceState:{deviceName}")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds custom key/value pairs to add to the user event. Ex. { \"variables\": { \"key\": \"value\" } }")] = None, **kwargs) -> None:  # noqa: E501
        """Generate a user event.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_event(event_name, application, source, variables, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.user_event_with_http_info(event_name, application, source, variables, **kwargs)  # noqa: E501

    @validate_arguments
    def user_event_with_http_info(self, event_name : Annotated[StrictStr, Field(..., description="Event name")], application : Annotated[StrictStr, Field(..., description="The name of the application that will receive this event")], source : Annotated[Optional[conlist(StrictStr)], Field(description="URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}/{resource}, deviceState:{deviceName}")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds custom key/value pairs to add to the user event. Ex. { \"variables\": { \"key\": \"value\" } }")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Generate a user event.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_event_with_http_info(event_name, application, source, variables, async_req=True)
        >>> result = thread.get()
