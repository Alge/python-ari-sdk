...
class ChannelsApi:
    ...
    @validate_arguments
    def add_moh(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], moh_class : Annotated[Optional[StrictStr], Field(description="Music on hold class to use")] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.add_moh(channel_id, moh_class, async_req=True)
        >>> result = thread.get()
        ...
        return self.add_moh_with_http_info(channel_id, moh_class, **kwargs)  # noqa: E501

    @validate_arguments
    def add_moh_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], moh_class : Annotated[Optional[StrictStr], Field(description="Music on hold class to use")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Play music on hold to a channel.  # noqa: E501
        ...
        >>> thread = api.add_moh_with_http_info(channel_id, moh_class, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def answer(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Answer a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.answer(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.answer_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def answer_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Answer a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.answer_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def continue_in_dialplan(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], context : Annotated[Optional[StrictStr], Field(description="The context to continue to.")] = None, extension : Annotated[Optional[StrictStr], Field(description="The extension to continue to.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to continue to.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to continue to - will supersede 'priority' if both are provided.")] = None, **kwargs) -> None:  # noqa: E501
        """Exit application; continue execution in the dialplan.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.continue_in_dialplan(channel_id, context, extension, priority, label, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.continue_in_dialplan_with_http_info(channel_id, context, extension, priority, label, **kwargs)  # noqa: E501

    @validate_arguments
    def continue_in_dialplan_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], context : Annotated[Optional[StrictStr], Field(description="The context to continue to.")] = None, extension : Annotated[Optional[StrictStr], Field(description="The extension to continue to.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to continue to.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to continue to - will supersede 'priority' if both are provided.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Exit application; continue execution in the dialplan.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.continue_in_dialplan_with_http_info(channel_id, context, extension, priority, label, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def createchannel(self, endpoint : Annotated[StrictStr, Field(..., description="Endpoint for channel communication")], app : Annotated[StrictStr, Field(..., description="Stasis Application to place channel into")], app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="Unique ID of the calling channel")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> Channel:  # noqa: E501
        """Create channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.createchannel(endpoint, app, app_args, channel_id, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.createchannel_with_http_info(endpoint, app, app_args, channel_id, other_channel_id, originator, formats, variables, **kwargs)  # noqa: E501

    @validate_arguments
    def createchannel_with_http_info(self, endpoint : Annotated[StrictStr, Field(..., description="Endpoint for channel communication")], app : Annotated[StrictStr, Field(..., description="Stasis Application to place channel into")], app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="Unique ID of the calling channel")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.createchannel_with_http_info(endpoint, app, app_args, channel_id, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def deletemoh(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Stop playing music on hold to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.deletemoh(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.deletemoh_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def deletemoh_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stop playing music on hold to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.deletemoh_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def dial(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], caller : Annotated[Optional[StrictStr], Field(description="Channel ID of caller")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Dial timeout")] = None, **kwargs) -> None:  # noqa: E501
        """Dial a created channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dial(channel_id, caller, timeout, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.dial_with_http_info(channel_id, caller, timeout, **kwargs)  # noqa: E501

    @validate_arguments
    def dial_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], caller : Annotated[Optional[StrictStr], Field(description="Channel ID of caller")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Dial timeout")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Dial a created channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dial_with_http_info(channel_id, caller, timeout, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def external_media(self, app : Annotated[StrictStr, Field(..., description="Stasis Application to place channel into")], external_host : Annotated[StrictStr, Field(..., description="Hostname/ip:port of external host")], format : Annotated[StrictStr, Field(..., description="Format to encode audio in")], channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, encapsulation : Annotated[Optional[StrictStr], Field(description="Payload encapsulation protocol")] = None, transport : Annotated[Optional[StrictStr], Field(description="Transport protocol")] = None, connection_type : Annotated[Optional[StrictStr], Field(description="Connection type (client/server)")] = None, direction : Annotated[Optional[StrictStr], Field(description="External media direction")] = None, data : Annotated[Optional[StrictStr], Field(description="An arbitrary data field")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> Channel:  # noqa: E501
        ...
        >>> thread = api.external_media(app, external_host, format, channel_id, encapsulation, transport, connection_type, direction, data, variables, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.external_media_with_http_info(app, external_host, format, channel_id, encapsulation, transport, connection_type, direction, data, variables, **kwargs)  # noqa: E501

    @validate_arguments
    def external_media_with_http_info(self, app : Annotated[StrictStr, Field(..., description="Stasis Application to place channel into")], external_host : Annotated[StrictStr, Field(..., description="Hostname/ip:port of external host")], format : Annotated[StrictStr, Field(..., description="Format to encode audio in")], channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, encapsulation : Annotated[Optional[StrictStr], Field(description="Payload encapsulation protocol")] = None, transport : Annotated[Optional[StrictStr], Field(description="Transport protocol")] = None, connection_type : Annotated[Optional[StrictStr], Field(description="Connection type (client/server)")] = None, direction : Annotated[Optional[StrictStr], Field(description="External media direction")] = None, data : Annotated[Optional[StrictStr], Field(description="An arbitrary data field")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start an External Media session.  # noqa: E501
        ...
        >>> thread = api.external_media_with_http_info(app, external_host, format, channel_id, encapsulation, transport, connection_type, direction, data, variables, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_channel_var(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], variable : Annotated[StrictStr, Field(..., description="The channel variable or function to get")], **kwargs) -> Variable:  # noqa: E501
        """Get the value of a channel variable or function.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_channel_var(channel_id, variable, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_channel_var_with_http_info(channel_id, variable, **kwargs)  # noqa: E501

    @validate_arguments
    def get_channel_var_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], variable : Annotated[StrictStr, Field(..., description="The channel variable or function to get")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get the value of a channel variable or function.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_channel_var_with_http_info(channel_id, variable, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def getchannel(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> Channel:  # noqa: E501
        """Channel details.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.getchannel(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.getchannel_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def getchannel_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Channel details.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.getchannel_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    def hangup(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], reason_code : Annotated[Optional[StrictStr], Field(description="The reason code for hanging up the channel for detail use. Mutually exclusive with 'reason'. See detail hangup codes at here. https://wiki.asterisk.org/wiki/display/AST/Hangup+Cause+Mappings")] = None, reason : Annotated[Optional[StrictStr], Field(description="Reason for hanging up the channel for simple use. Mutually exclusive with 'reason_code'.")] = None, **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.hangup_with_http_info(channel_id, reason_code, reason, **kwargs)  # noqa: E501

    @validate_arguments
    def hangup_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], reason_code : Annotated[Optional[StrictStr], Field(description="The reason code for hanging up the channel for detail use. Mutually exclusive with 'reason'. See detail hangup codes at here. https://wiki.asterisk.org/wiki/display/AST/Hangup+Cause+Mappings")] = None, reason : Annotated[Optional[StrictStr], Field(description="Reason for hanging up the channel for simple use. Mutually exclusive with 'reason_code'.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete (i.e. hangup) a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.hangup_with_http_info(channel_id, reason_code, reason, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def hold(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Hold a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.hold(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.hold_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def hold_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Hold a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.hold_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def listchannels(self, **kwargs) -> List[Channel]:  # noqa: E501
        """List all active channels in Asterisk.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.listchannels(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.listchannels_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def listchannels_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List all active channels in Asterisk.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.listchannels_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def move(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], app : Annotated[StrictStr, Field(..., description="The channel will be passed to this Stasis application.")], app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'.")] = None, **kwargs) -> None:  # noqa: E501
        """Move the channel from one Stasis application to another.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.move(channel_id, app, app_args, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.move_with_http_info(channel_id, app, app_args, **kwargs)  # noqa: E501
    ...
    def move_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], app : Annotated[StrictStr, Field(..., description="The channel will be passed to this Stasis application.")], app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.move_with_http_info(channel_id, app, app_args, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def mute(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], direction : Annotated[Optional[StrictStr], Field(description="Direction in which to mute audio")] = None, **kwargs) -> None:  # noqa: E501
        """Mute a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mute(channel_id, direction, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.mute_with_http_info(channel_id, direction, **kwargs)  # noqa: E501

    @validate_arguments
    def mute_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], direction : Annotated[Optional[StrictStr], Field(description="Direction in which to mute audio")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Mute a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mute_with_http_info(channel_id, direction, async_req=True)
        >>> result = thread.get()
    ...
    def originate(self, endpoint : Annotated[StrictStr, Field(..., description="Endpoint to call.")], extension : Annotated[Optional[StrictStr], Field(description="The extension to dial after the endpoint answers. Mutually exclusive with 'app'.")] = None, context : Annotated[Optional[StrictStr], Field(description="The context to dial after the endpoint answers. If omitted, uses 'default'. Mutually exclusive with 'app'.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to dial after the endpoint answers. If omitted, uses 1. Mutually exclusive with 'app'.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to dial after the endpoint answers. Will supersede 'priority' if provided. Mutually exclusive with 'app'.")] = None, app : Annotated[Optional[StrictStr], Field(description="The application that is subscribed to the originated channel. When the channel is answered, it will be passed to this Stasis application. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, caller_id : Annotated[Optional[StrictStr], Field(description="CallerID to use when dialing the endpoint or extension.")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Timeout (in seconds) before giving up dialing, or -1 for no timeout.")] = None, channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="The unique id of the channel which is originating this one.")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> Channel:  # noqa: E501
        ...
        >>> thread = api.originate(endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, channel_id, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.originate_with_http_info(endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, channel_id, other_channel_id, originator, formats, variables, **kwargs)  # noqa: E501

    @validate_arguments
    def originate_with_http_info(self, endpoint : Annotated[StrictStr, Field(..., description="Endpoint to call.")], extension : Annotated[Optional[StrictStr], Field(description="The extension to dial after the endpoint answers. Mutually exclusive with 'app'.")] = None, context : Annotated[Optional[StrictStr], Field(description="The context to dial after the endpoint answers. If omitted, uses 'default'. Mutually exclusive with 'app'.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to dial after the endpoint answers. If omitted, uses 1. Mutually exclusive with 'app'.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to dial after the endpoint answers. Will supersede 'priority' if provided. Mutually exclusive with 'app'.")] = None, app : Annotated[Optional[StrictStr], Field(description="The application that is subscribed to the originated channel. When the channel is answered, it will be passed to this Stasis application. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, caller_id : Annotated[Optional[StrictStr], Field(description="CallerID to use when dialing the endpoint or extension.")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Timeout (in seconds) before giving up dialing, or -1 for no timeout.")] = None, channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the channel on creation.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="The unique id of the channel which is originating this one.")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new channel (originate).  # noqa: E501
        ...
        >>> thread = api.originate_with_http_info(endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, channel_id, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
    ...
    def originate_with_id(self, channel_id : Annotated[StrictStr, Field(..., description="The unique id to assign the channel on creation.")], endpoint : Annotated[StrictStr, Field(..., description="Endpoint to call.")], extension : Annotated[Optional[StrictStr], Field(description="The extension to dial after the endpoint answers. Mutually exclusive with 'app'.")] = None, context : Annotated[Optional[StrictStr], Field(description="The context to dial after the endpoint answers. If omitted, uses 'default'. Mutually exclusive with 'app'.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to dial after the endpoint answers. If omitted, uses 1. Mutually exclusive with 'app'.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to dial after the endpoint answers. Will supersede 'priority' if provided. Mutually exclusive with 'app'.")] = None, app : Annotated[Optional[StrictStr], Field(description="The application that is subscribed to the originated channel. When the channel is answered, it will be passed to this Stasis application. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, caller_id : Annotated[Optional[StrictStr], Field(description="CallerID to use when dialing the endpoint or extension.")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Timeout (in seconds) before giving up dialing, or -1 for no timeout.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="The unique id of the channel which is originating this one.")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> Channel:  # noqa: E501
        ...
        >>> thread = api.originate_with_id(channel_id, endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.originate_with_id_with_http_info(channel_id, endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, other_channel_id, originator, formats, variables, **kwargs)  # noqa: E501

    @validate_arguments
    def originate_with_id_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="The unique id to assign the channel on creation.")], endpoint : Annotated[StrictStr, Field(..., description="Endpoint to call.")], extension : Annotated[Optional[StrictStr], Field(description="The extension to dial after the endpoint answers. Mutually exclusive with 'app'.")] = None, context : Annotated[Optional[StrictStr], Field(description="The context to dial after the endpoint answers. If omitted, uses 'default'. Mutually exclusive with 'app'.")] = None, priority : Annotated[Optional[StrictInt], Field(description="The priority to dial after the endpoint answers. If omitted, uses 1. Mutually exclusive with 'app'.")] = None, label : Annotated[Optional[StrictStr], Field(description="The label to dial after the endpoint answers. Will supersede 'priority' if provided. Mutually exclusive with 'app'.")] = None, app : Annotated[Optional[StrictStr], Field(description="The application that is subscribed to the originated channel. When the channel is answered, it will be passed to this Stasis application. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application provided by 'app'. Mutually exclusive with 'context', 'extension', 'priority', and 'label'.")] = None, caller_id : Annotated[Optional[StrictStr], Field(description="CallerID to use when dialing the endpoint or extension.")] = None, timeout : Annotated[Optional[StrictInt], Field(description="Timeout (in seconds) before giving up dialing, or -1 for no timeout.")] = None, other_channel_id : Annotated[Optional[StrictStr], Field(description="The unique id to assign the second channel when using local channels.")] = None, originator : Annotated[Optional[StrictStr], Field(description="The unique id of the channel which is originating this one.")] = None, formats : Annotated[Optional[StrictStr], Field(description="The format name capability list to use if originator is not specified. Ex. \"ulaw,slin16\".  Format names can be found with \"core show codecs\".")] = None, variables : Annotated[Optional[Dict[str, Any]], Field(description="The \"variables\" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { \"endpoint\": \"SIP/Alice\", \"variables\": { \"CALLERID(name)\": \"Alice\" } }")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new channel (originate with id).  # noqa: E501
        ...
        >>> thread = api.originate_with_id_with_http_info(channel_id, endpoint, extension, context, priority, label, app, app_args, caller_id, timeout, other_channel_id, originator, formats, variables, async_req=True)
        >>> result = thread.get()
    ...
    def play_sound_with_id(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], playback_id : Annotated[StrictStr, Field(..., description="Playback ID.")], media : Annotated[conlist(StrictStr), Field(..., description="Media URIs to play.")], lang : Annotated[Optional[StrictStr], Field(description="For sounds, selects language for sound.")] = None, offsetms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.")] = None, skipms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip for forward/reverse operations.")] = None, **kwargs) -> Playback:  # noqa: E501
        ...
        >>> thread = api.play_sound_with_id(channel_id, playback_id, media, lang, offsetms, skipms, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.play_sound_with_id_with_http_info(channel_id, playback_id, media, lang, offsetms, skipms, **kwargs)  # noqa: E501

    @validate_arguments
    def play_sound_with_id_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], playback_id : Annotated[StrictStr, Field(..., description="Playback ID.")], media : Annotated[conlist(StrictStr), Field(..., description="Media URIs to play.")], lang : Annotated[Optional[StrictStr], Field(description="For sounds, selects language for sound.")] = None, offsetms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.")] = None, skipms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip for forward/reverse operations.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start playback of media and specify the playbackId.  # noqa: E501
        ...
        >>> thread = api.play_sound_with_id_with_http_info(channel_id, playback_id, media, lang, offsetms, skipms, async_req=True)
        >>> result = thread.get()
    ...
    def playsound(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], media : Annotated[conlist(StrictStr), Field(..., description="Media URIs to play.")], lang : Annotated[Optional[StrictStr], Field(description="For sounds, selects language for sound.")] = None, offsetms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.")] = None, skipms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip for forward/reverse operations.")] = None, playback_id : Annotated[Optional[StrictStr], Field(description="Playback ID.")] = None, **kwargs) -> Playback:  # noqa: E501
        ...
        >>> thread = api.playsound(channel_id, media, lang, offsetms, skipms, playback_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.playsound_with_http_info(channel_id, media, lang, offsetms, skipms, playback_id, **kwargs)  # noqa: E501

    @validate_arguments
    def playsound_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], media : Annotated[conlist(StrictStr), Field(..., description="Media URIs to play.")], lang : Annotated[Optional[StrictStr], Field(description="For sounds, selects language for sound.")] = None, offsetms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.")] = None, skipms : Annotated[Optional[StrictInt], Field(description="Number of milliseconds to skip for forward/reverse operations.")] = None, playback_id : Annotated[Optional[StrictStr], Field(description="Playback ID.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start playback of media.  # noqa: E501
        ...
        >>> thread = api.playsound_with_http_info(channel_id, media, lang, offsetms, skipms, playback_id, async_req=True)
        >>> result = thread.get()
    ...
    def recordchannel(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], name : Annotated[StrictStr, Field(..., description="Recording's filename")], format : Annotated[StrictStr, Field(..., description="Format to encode audio in")], max_duration_seconds : Annotated[Optional[StrictInt], Field(description="Maximum duration of the recording, in seconds. 0 for no limit")] = None, max_silence_seconds : Annotated[Optional[StrictInt], Field(description="Maximum duration of silence, in seconds. 0 for no limit")] = None, if_exists : Annotated[Optional[StrictStr], Field(description="Action to take if a recording with the same name already exists.")] = None, beep : Annotated[Optional[StrictBool], Field(description="Play beep when recording begins")] = None, terminate_on : Annotated[Optional[StrictStr], Field(description="DTMF input to terminate recording")] = None, **kwargs) -> LiveRecording:  # noqa: E501
        ...
        >>> thread = api.recordchannel(channel_id, name, format, max_duration_seconds, max_silence_seconds, if_exists, beep, terminate_on, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.recordchannel_with_http_info(channel_id, name, format, max_duration_seconds, max_silence_seconds, if_exists, beep, terminate_on, **kwargs)  # noqa: E501

    @validate_arguments
    def recordchannel_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], name : Annotated[StrictStr, Field(..., description="Recording's filename")], format : Annotated[StrictStr, Field(..., description="Format to encode audio in")], max_duration_seconds : Annotated[Optional[StrictInt], Field(description="Maximum duration of the recording, in seconds. 0 for no limit")] = None, max_silence_seconds : Annotated[Optional[StrictInt], Field(description="Maximum duration of silence, in seconds. 0 for no limit")] = None, if_exists : Annotated[Optional[StrictStr], Field(description="Action to take if a recording with the same name already exists.")] = None, beep : Annotated[Optional[StrictBool], Field(description="Play beep when recording begins")] = None, terminate_on : Annotated[Optional[StrictStr], Field(description="DTMF input to terminate recording")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start a recording.  # noqa: E501
        ...
        >>> thread = api.recordchannel_with_http_info(channel_id, name, format, max_duration_seconds, max_silence_seconds, if_exists, beep, terminate_on, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def redirect(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], endpoint : Annotated[StrictStr, Field(..., description="The endpoint to redirect the channel to")], **kwargs) -> None:  # noqa: E501
        """Redirect the channel to a different location.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.redirect(channel_id, endpoint, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.redirect_with_http_info(channel_id, endpoint, **kwargs)  # noqa: E501

    @validate_arguments
    def redirect_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], endpoint : Annotated[StrictStr, Field(..., description="The endpoint to redirect the channel to")], **kwargs) -> ApiResponse:  # noqa: E501
        """Redirect the channel to a different location.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.redirect_with_http_info(channel_id, endpoint, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def ring(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Indicate ringing to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.ring(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.ring_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def ring_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Indicate ringing to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.ring_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def ring_stop(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Stop ringing indication on a channel if locally generated.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.ring_stop(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.ring_stop_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def ring_stop_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stop ringing indication on a channel if locally generated.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.ring_stop_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def rtpstatistics(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> RTPstat:  # noqa: E501
        """RTP stats on a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.rtpstatistics(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.rtpstatistics_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def rtpstatistics_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """RTP stats on a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.rtpstatistics_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    def send_dtmf(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], dtmf : Annotated[Optional[StrictStr], Field(description="DTMF To send.")] = None, before : Annotated[Optional[StrictInt], Field(description="Amount of time to wait before DTMF digits (specified in milliseconds) start.")] = None, between : Annotated[Optional[StrictInt], Field(description="Amount of time in between DTMF digits (specified in milliseconds).")] = None, duration : Annotated[Optional[StrictInt], Field(description="Length of each DTMF digit (specified in milliseconds).")] = None, after : Annotated[Optional[StrictInt], Field(description="Amount of time to wait after DTMF digits (specified in milliseconds) end.")] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.send_dtmf(channel_id, dtmf, before, between, duration, after, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.send_dtmf_with_http_info(channel_id, dtmf, before, between, duration, after, **kwargs)  # noqa: E501

    @validate_arguments
    def send_dtmf_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], dtmf : Annotated[Optional[StrictStr], Field(description="DTMF To send.")] = None, before : Annotated[Optional[StrictInt], Field(description="Amount of time to wait before DTMF digits (specified in milliseconds) start.")] = None, between : Annotated[Optional[StrictInt], Field(description="Amount of time in between DTMF digits (specified in milliseconds).")] = None, duration : Annotated[Optional[StrictInt], Field(description="Length of each DTMF digit (specified in milliseconds).")] = None, after : Annotated[Optional[StrictInt], Field(description="Amount of time to wait after DTMF digits (specified in milliseconds) end.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Send provided DTMF to a given channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.send_dtmf_with_http_info(channel_id, dtmf, before, between, duration, after, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def set_channel_var(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], variable : Annotated[StrictStr, Field(..., description="The channel variable or function to set")], value : Annotated[Optional[StrictStr], Field(description="The value to set the variable to")] = None, **kwargs) -> None:  # noqa: E501
        """Set the value of a channel variable or function.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.set_channel_var(channel_id, variable, value, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.set_channel_var_with_http_info(channel_id, variable, value, **kwargs)  # noqa: E501

    @validate_arguments
    def set_channel_var_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], variable : Annotated[StrictStr, Field(..., description="The channel variable or function to set")], value : Annotated[Optional[StrictStr], Field(description="The value to set the variable to")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Set the value of a channel variable or function.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.set_channel_var_with_http_info(channel_id, variable, value, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def snoop_channel(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], app : Annotated[StrictStr, Field(..., description="Application the snooping channel is placed into")], spy : Annotated[Optional[StrictStr], Field(description="Direction of audio to spy on")] = None, whisper : Annotated[Optional[StrictStr], Field(description="Direction of audio to whisper into")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application")] = None, snoop_id : Annotated[Optional[StrictStr], Field(description="Unique ID to assign to snooping channel")] = None, **kwargs) -> Channel:  # noqa: E501
        ...
        >>> thread = api.snoop_channel(channel_id, app, spy, whisper, app_args, snoop_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.snoop_channel_with_http_info(channel_id, app, spy, whisper, app_args, snoop_id, **kwargs)  # noqa: E501

    @validate_arguments
    def snoop_channel_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], app : Annotated[StrictStr, Field(..., description="Application the snooping channel is placed into")], spy : Annotated[Optional[StrictStr], Field(description="Direction of audio to spy on")] = None, whisper : Annotated[Optional[StrictStr], Field(description="Direction of audio to whisper into")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application")] = None, snoop_id : Annotated[Optional[StrictStr], Field(description="Unique ID to assign to snooping channel")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start snooping.  # noqa: E501
        ...
        >>> thread = api.snoop_channel_with_http_info(channel_id, app, spy, whisper, app_args, snoop_id, async_req=True)
        >>> result = thread.get()
    ...
    def snoop_channel_with_id(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], snoop_id : Annotated[StrictStr, Field(..., description="Unique ID to assign to snooping channel")], app : Annotated[StrictStr, Field(..., description="Application the snooping channel is placed into")], spy : Annotated[Optional[StrictStr], Field(description="Direction of audio to spy on")] = None, whisper : Annotated[Optional[StrictStr], Field(description="Direction of audio to whisper into")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application")] = None, **kwargs) -> Channel:  # noqa: E501
        ...
        >>> thread = api.snoop_channel_with_id(channel_id, snoop_id, app, spy, whisper, app_args, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.snoop_channel_with_id_with_http_info(channel_id, snoop_id, app, spy, whisper, app_args, **kwargs)  # noqa: E501

    @validate_arguments
    def snoop_channel_with_id_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], snoop_id : Annotated[StrictStr, Field(..., description="Unique ID to assign to snooping channel")], app : Annotated[StrictStr, Field(..., description="Application the snooping channel is placed into")], spy : Annotated[Optional[StrictStr], Field(description="Direction of audio to spy on")] = None, whisper : Annotated[Optional[StrictStr], Field(description="Direction of audio to whisper into")] = None, app_args : Annotated[Optional[StrictStr], Field(description="The application arguments to pass to the Stasis application")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Start snooping.  # noqa: E501
        ...
        >>> thread = api.snoop_channel_with_id_with_http_info(channel_id, snoop_id, app, spy, whisper, app_args, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def start_silence(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.start_silence(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.start_silence_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def start_silence_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Play silence to a channel.  # noqa: E501
        ...
        >>> thread = api.start_silence_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def stop_silence(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Stop playing silence to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.stop_silence(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.stop_silence_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def stop_silence_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stop playing silence to a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.stop_silence_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def unhold(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> None:  # noqa: E501
        """Remove a channel from hold.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.unhold(channel_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.unhold_with_http_info(channel_id, **kwargs)  # noqa: E501

    @validate_arguments
    def unhold_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove a channel from hold.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.unhold_with_http_info(channel_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def unmute(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], direction : Annotated[Optional[StrictStr], Field(description="Direction in which to unmute audio")] = None, **kwargs) -> None:  # noqa: E501
        """Unmute a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.unmute(channel_id, direction, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.unmute_with_http_info(channel_id, direction, **kwargs)  # noqa: E501

    @validate_arguments
    def unmute_with_http_info(self, channel_id : Annotated[StrictStr, Field(..., description="Channel's id")], direction : Annotated[Optional[StrictStr], Field(description="Direction in which to unmute audio")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Unmute a channel.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.unmute_with_http_info(channel_id, direction, async_req=True)
        >>> result = thread.get()
