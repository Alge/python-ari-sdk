...
class ChannelHold(Event):
    ...
    musicclass: Optional[StrictStr] = Field(default=None, description="The music on hold class that the initiator requested.")
    __properties = ["application", "timestamp", "asterisk_id", "type", "channel", "musicclass"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelHold:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelHold:
        """Create an instance of ChannelHold from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelHold.parse_obj(obj)

        _obj = ChannelHold.parse_obj({
