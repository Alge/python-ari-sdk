...
class ContactStatusChange(Event):
    ...
    __properties = ["application", "timestamp", "asterisk_id", "type", "contact_info", "endpoint"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactStatusChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactStatusChange:
        """Create an instance of ContactStatusChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactStatusChange.parse_obj(obj)

        _obj = ContactStatusChange.parse_obj({
            "application": obj.get("application"),
            "timestamp": obj.get("timestamp"),
            "asterisk_id": obj.get("asterisk_id"),
            "type": obj.get("type"),
            "contact_info": ContactInfo.from_dict(obj.get("contact_info")) if obj.get("contact_info") is not None else None,
